...
import NumberShuffle from '@/registry/components/motion-number/numbersuffle'

export default function HomeMotionNumber() {
  ...
  return (
    <div className="h-full grid place-content-center">
      <NumberShuffle currentValue={numbers[currentIndex]} />
      <button
