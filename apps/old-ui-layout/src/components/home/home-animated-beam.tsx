...
import { AnimatedBeam, Circle } from '@/registry/components/animated-beam/beam'
import React, { forwardRef, useRef } from 'react'

export default function HomeAnimatedBeam() {
  ...
  return (
    <div className="h-full flex items-center">
      <div
        className="relative flex w-full mx-auto items-center max-h-[300px]  justify-center overflow-hidden rounded-lg p-10"
        ref={containerRef}
      >
        <div className="flex h-full w-full flex-col  gap-10">
          ...
          <div className="flex flex-row items-center justify-between">
            ...
            <Circle className="p-2" ref={div7Ref}>
              <Icons.reactjs />
            </Circle>
          </div>
        </div>
        ...
        <AnimatedBeam
          ...
          toRef={div4Ref}
          dotted
          gradientStartColor="#e300b3"
          gradientStopColor="#7d11ff"
        />
        <AnimatedBeam
          containerRef={containerRef}
          fromRef={div3Ref}
        ...
        <AnimatedBeam
          ...
          reverse
          dotted
          gradientStartColor="#81ba3a"
          gradientStopColor="#00c472"
        />
        <AnimatedBeam
          containerRef={containerRef}
          fromRef={div7Ref}
