...
<Tabs defaultValue="preview" className="w-full relative">
  ...
  <TabsContent value="preview">
    <ComponentPreview name="scrollbasedmaquee" category="beam" />
  </TabsContent>
...
<Tabs defaultValue="preview" className="w-full relative">
  ...
  <TabsContent value="preview">
    <ComponentPreview name="scrollbasedmaquee2" category="beam" />
  </TabsContent>
  <TabsContent value="codesnippet">
    <CodeWrapper noExpand={true}>
      <CodePreview name="scrollbasedmaquee2" category="beam" />
    </CodeWrapper>
  </TabsContent>
</Tabs>
