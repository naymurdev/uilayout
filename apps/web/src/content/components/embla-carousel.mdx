...
description: An animated carousel component using Embla Carousel, providing smooth, interactive transitions between slides with customizable animation effects.
component: true
---
...
<Tabs defaultValue="preview" className="w-full relative">
  ...
  <TabsContent value="preview">
    <ComponentPreview basicPadding={true} name="carousel3" category="carousel" />
  </TabsContent>
...
<Tabs defaultValue="preview" className="w-full relative">
  ...
  <TabsContent value="preview">
    <ComponentPreview basicPadding={true} name="carousel5" category="carousel" />
  </TabsContent>
  <TabsContent value="codesnippet">
    <CodeWrapper noExpand={true}>
...
<Tabs defaultValue="preview" className="w-full relative">
  ...
  <TabsContent value="preview">
    <ComponentPreview basicPadding={true} name="carousel6" category="carousel" />
  </TabsContent>
  <TabsContent value="codesnippet">
    <CodeWrapper noExpand={true}>
...
<Tabs defaultValue="preview" className="w-full relative">
  ...
  <TabsContent value="preview">
    <ComponentPreview basicPadding={true} name="carousel10" category="carousel" />
  </TabsContent>
  <TabsContent value="codesnippet">
    <CodeWrapper noExpand={true}>
...
<Tabs defaultValue="preview" className="w-full relative">
  ...
  <TabsContent value="preview">
    <ComponentPreview basicPadding={true} name="carousel8" category="carousel" />
  </TabsContent>
  <TabsContent value="codesnippet">
    <CodeWrapper noExpand={true}>
