...
<Tabs defaultValue="preview" className="w-full relative">
  ...
  <TabsContent value="preview">
    <BasicComponentPreview name="carousel3" category="carousel" />
  </TabsContent>
  <TabsContent value="codesnippet">
    <CodeWrapper noExpand={true}>
      <CodePreview name="carousel3" category="carousel" />
    </CodeWrapper>
      ...
      <div className="flex gap-2">
        {scrollSnaps.map((_: any, index: React.Key | null | undefined) => (
          <button
            ...
            className={`relative inline-flex cursor-pointer  border-2 dark:border-white border-black p-0 m-0 w-4 h-4 z-[1] rounded-full`}
          >
            {index === selectedIndex && (
              <div className="absolute w-full h-full left-0 top-0 dark:bg-white bg-black rounded-full  z-[1]"></div>
            )}
          </button>
        ))}
      </div>
...
<Tabs defaultValue="preview" className="w-full relative">
  ...
  <TabsContent value="preview">
    <BasicComponentPreview name="carousel4" category="carousel" />
  </TabsContent>
  <TabsContent value="codesnippet">
    <CodeWrapper noExpand={true}>
      <CodePreview name="carousel4" category="carousel" />
    </CodeWrapper>
  </TabsContent>
</Tabs>
...
<Tabs defaultValue="preview" className="w-full relative">
  ...
  <TabsContent value="preview">
    <BasicComponentPreview name="carousel5" category="carousel" />
  </TabsContent>
  <TabsContent value="codesnippet">
    <CodeWrapper noExpand={true}>
      <CodePreview name="carousel5" category="carousel" />
...
<Tabs defaultValue="preview" className="w-full relative">
  ...
  <TabsContent value="preview">
    <BasicComponentPreview name="carousel6" category="carousel" />
  </TabsContent>
  <TabsContent value="codesnippet">
    <CodeWrapper noExpand={true}>
      <CodePreview name="carousel6" category="carousel" />
    </CodeWrapper>
...
<Tabs defaultValue="preview" className="w-full relative">
  ...
  <TabsContent value="preview">
    <BasicComponentPreview name="carousel7" category="carousel" />
  </TabsContent>
  <TabsContent value="codesnippet">
    <CodeWrapper>
      <CodePreview name="carousel7" category="carousel" />
    </CodeWrapper>
  </TabsContent>
</Tabs>
...
<Tabs defaultValue="preview" className="w-full relative">
  ...
  <TabsContent value="preview">
    <BasicComponentPreview name="carousel10" category="carousel" />
  </TabsContent>
  <TabsContent value="codesnippet">
    <CodeWrapper noExpand={true}>
      <CodePreview name="carousel10" category="carousel" />
...
<Tabs defaultValue="preview" className="w-full relative">
  ...
  <TabsContent value="preview">
    <BasicComponentPreview name="carousel8" category="carousel" />
  </TabsContent>
  <TabsContent value="codesnippet">
    <CodeWrapper noExpand={true}>
      <CodePreview name="carousel8" category="carousel" />
      </CodeWrapper>
