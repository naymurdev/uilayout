...
<Tabs defaultValue="preview" className="w-full relative">
  ...
  <TabsContent value="preview">
    <IframeLinkPreviewComponent weblink="sparkles-globe" category="carousel" />
  </TabsContent>
...
<Tabs defaultValue="preview" className="w-full relative">
  ...
  <TabsContent value="preview">
    <IframeLinkPreviewComponent weblink="sparkles-section" category="carousel" />
  </TabsContent>
  <TabsContent value="codesnippet">
    <CodeWrapper noExpand={true}>
...
<Tabs defaultValue="preview" className="w-full relative">
  ...
  <TabsContent value="preview">
    <IframeLinkPreviewComponent weblink="sparkles-branding" category="sparkles" />
  </TabsContent>
  <TabsContent value="codesnippet">
    <CodeWrapper noExpand={true}>
