---
title: Dialog
description: An animated dialog component powered by Framer Motion, offering smooth transitions and interactive visual effects for modal windows
component: true
links:
...
<Tabs defaultValue="preview" className="w-full relative">
  ...
  <TabsContent value="preview">
    <ComponentPreview name="dialog" category="modal" />
  </TabsContent>
  <TabsContent value="codesnippet">
    <CodeWrapper>
      <CodePreview name="dialog" category="modal" />
    </CodeWrapper>
