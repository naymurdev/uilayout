...
<Tabs defaultValue="preview" className="w-full relative">
  ...
  <TabsContent value="preview">
    <BasicComponentPreview name="spotlightCard1" category="carousel" />
  </TabsContent>
...
<Tabs defaultValue="preview" className="w-full relative">
  ...
  <TabsContent value="preview">
    <BasicComponentPreview name="spotlightCard2" category="carousel" />
  </TabsContent>
  <TabsContent value="codesnippet">
...
<Tabs defaultValue="preview" className="w-full relative">
  ...
  <TabsContent value="preview">
    <BasicComponentPreview name="spotlightCard3" category="carousel" />
  </TabsContent>
  <TabsContent value="codesnippet">
...
<Tabs defaultValue="preview" className="w-full relative">
  ...
  <TabsContent value="preview">
    <BasicComponentPreview name="spotlightCard4" category="carousel" />
  </TabsContent>
  <TabsContent value="codesnippet">
