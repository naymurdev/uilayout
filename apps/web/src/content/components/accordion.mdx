...
<Tabs defaultValue="preview" className="w-full relative">
  ...
  <TabsContent
    value="preview"
  >
    <ComponentPreview  name="accordion1" category="component">
  ...
  <TabsContent value="codesnippet">
    <CodeWrapper noExpand={true}>
     <CodePreview name="accordion1" category="component" />
    </CodeWrapper>
  </TabsContent>
</Tabs>
...
<Tabs defaultValue="preview" className="w-full relative">
  ...
  <TabsContent value="preview">
    <ComponentPreview name="accordion2" category="component" />
  </TabsContent>
  <TabsContent value="codesnippet">
    <CodePreview name="accordion2" category="component" />
  </TabsContent>
</Tabs>
...
<Tabs defaultValue="preview" className="w-full relative">
  ...
  <TabsContent value="preview">
    <ComponentPreview name="accordion3" category="component" />
  </TabsContent>
  <TabsContent value="codesnippet">
    <CodePreview name="accordion3" category="component" />
  </TabsContent>
</Tabs>
...
<Tabs defaultValue="preview" className="w-full relative">
  ...
  <TabsContent value="preview">
    ...
    <ComponentPreview name="accordion5" category="component">
  ...
  <TabsContent value="codesnippet" >
  <CodeWrapper>
    <CodePreview name="accordion5" category="component" />
