...
function HomeImageMasking() {
  return (
    <>
      <div className="h-full flex items-center md:p-4 sm:p-20 p-4 ">
        <section
          className="relative"
          style={{
        ...
        >
          <video
            ...
            muted
            loop
            className="w-full  h-full object-cover transition-all  aspect-square hover:scale-110"
          >
            <source
...
export default HomeImageMasking
