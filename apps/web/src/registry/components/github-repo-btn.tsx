...
export default function GitHubButton({
  ...
  return (
    <button
      className={cn(
        `flex items-center space-x-2 group  px-2 rounded-md bg-primary-foreground text-primary border`,
        classname
      )}
      onClick={() =>
    ...
    >
      ...
      {isLoading ? (
        ...
        <span className="ml-2 bg-primary px-2 py-0.5 rounded-full text-sm font-semibold text-primary-foreground">
