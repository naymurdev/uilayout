    ...
    <>
      <div className="w-[400px] relative mt-4 h-[500px] overflow-hidden group mx-auto dark:bg-black  bg-white dark:border-0 border rounded-md dark:text-white text-black flex flex-col">
        <div className="w-full h-full ">
          <Image
            src={
              'https://res.cloudinary.com/dzl9yxixg/image/upload/space_russel_whneqf.jpg'
            }
            alt="shoes"
            width={600}
            height={600}
        ...
        <article className="p-8 w-full h-full overflow-hidden z-10  absolute top-0 flex flex-col justify-end rounded-md   bg-[#ff864e]  opacity-0 group-hover:opacity-100  transition-all duration-300">
        ...
        <article className="p-2 w-full h-[20%] flex flex-col justify-end  overflow-hidden  absolute bottom-0 rounded-b-md bg-gradient-to-t from-[#ff864e]  opacity-100 group-hover:opacity-0 group-hover:-bottom-4 transition-all duration-300">
