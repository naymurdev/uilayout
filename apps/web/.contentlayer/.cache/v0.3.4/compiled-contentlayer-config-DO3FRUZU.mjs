...
var COMPONENTS = [
  {
    ...
    componentArray: [
      ...
      },
      {
        ...
        componentSrc: React.lazy(
          () => import("@/registry/components/accordion/framer/imglayout/index")
        )
      },
      {
  ...
  },
  {
    ...
    componentArray: [
      ...
      },
      {
        ...
        componentSrc: React.lazy(
          () => import("@/registry/components/tabs/img-tabs/img-tab3")
        )
      }
    ],
    filesArray: [
...
//# sourceMappingURL=compiled-contentlayer-config-DO3FRUZU.mjs.map
