  ...
  },
  {
    ...
    filesArray: [
      ...
      },
      {
        ...
        fileSrc: "./src/registry/components/text-animation/text-marque/animationtwo.tsx"
      },
      {
        fileName: "Randomized-text-unveil",
        fileSrc: "./src/registry/components/text-animation/text-randomized/index.tsx"
      }
    ],
    slug: "text-animation",
    type: "text-animation"
    ...
    componentArray: [
      {
        ...
        componentSrc: React.lazy(
          () => import("@/registry/components/creative/blurvignette/blurvignetteimg")
        )
      },
      {
        componentName: "blur-vignettecard",
        componentSrc: React.lazy(
          () => import("@/registry/components/creative/blurvignette/blurvignettecard")
        )
      },
      {
        componentName: "blur-vignettevideo",
        componentSrc: React.lazy(
          () => import("@/registry/components/creative/blurvignette/blurvignettevideo")
        )
      }
    ],
    filesArray: [
      {
        ...
        fileSrc: "./src/registry/components/creative/blurvignette/blurvignetteimg.tsx"
      },
      {
        fileName: "blur-vignettecard",
        fileSrc: "./src/registry/components/creative/blurvignette/blurvignettecard.tsx"
      },
      {
        fileName: "blur-vignettevideo",
        fileSrc: "./src/registry/components/creative/blurvignette/blurvignettevideo.tsx"
      }
    ],
    slug: "blur",
  ...
  },
  {
    ...
    filesArray: [
      ...
      },
      {
        ...
        fileSrc: "./src/registry/components/motion-number/motion-number-before.tsx"
      },
      {
        fileName: "motionnumberafter",
        fileSrc: "./src/registry/components/motion-number/motion-number-after.tsx"
      },
      {
        fileName: "motionnumberlast",
        fileSrc: "./src/registry/components/motion-number/motion-number-last.tsx"
      },
      {
        fileName: "motionnumberstart",
        fileSrc: "./src/registry/components/motion-number/motion-number-start.tsx"
      }
    ],
    slug: "suffle-number",
    type: "number"
...
//# sourceMappingURL=compiled-contentlayer-config-NUFM5RQG.mjs.map
