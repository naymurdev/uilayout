    ...
    componentArray: [
      {
        ...
        componentSrc: React.lazy(
          () => import("@/registry/components/motion-number")
        )
      }
    ],
    filesArray: [
      {
        ...
        fileSrc: "./src/registry/components/motion-number/index.tsx"
      }
    ],
    slug: "suffle-number",
    type: "number"
...
//# sourceMappingURL=compiled-contentlayer-config-P3JPZASH.mjs.map
