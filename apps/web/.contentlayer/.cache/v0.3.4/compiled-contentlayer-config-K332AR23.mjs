...
var COMPONENTS = [
  {
    ...
    componentArray: [
      ...
      {
        componentName: "accordion4",
        componentSrc: React.lazy(
          () => import("@/registry/components/accordion/framer/imagelayout")
        )
      },
      {
    ...
    filesArray: [
      ...
      {
        fileName: "accordion4",
        fileSrc: "./src/registry/components/accordion/framer/imagelayout.tsx"
      },
      {
  ...
  },
  {
    ...
    componentArray: [
      {
        componentName: "defaultModal",
        componentSrc: React.lazy(
          () => import("@/registry/components/modal/default-modal")
        )
      },
      {
        componentName: "imgModal",
        componentSrc: React.lazy(
          () => import("@/registry/components/modal/image-modal")
        )
      },
      {
    ...
    filesArray: [
      {
        fileName: "defaultModal",
        fileSrc: "./src/registry/components/modal/default-modal/index.tsx"
      },
      {
        fileName: "imgModal",
        fileSrc: "./src/registry/components/modal/image-modal.tsx"
      },
      {
    ...
    componentArray: [
      {
        ...
        componentSrc: React.lazy(
          () => import("@/registry/components/carousel/carousel1")
        )
      },
      {
        componentName: "carousel2",
        componentSrc: React.lazy(
          () => import("@/registry/components/carousel/carousel2")
        )
      },
      {
      ...
      },
      {
        ...
        componentSrc: React.lazy(
          () => import("@/registry/components/carousel/embla/scale/scale-slider")
        )
      },
      {
        componentName: "carousel8",
        componentSrc: React.lazy(
          () => import("@/registry/components/carousel/embla/autostart/autostart-slider")
        )
      },
      {
        componentName: "carousel9",
        componentSrc: React.lazy(
          () => import("@/registry/components/carousel/embla/animation/animation-slider")
        )
      },
      {
        componentName: "carousel10",
        componentSrc: React.lazy(
          () => import("@/registry/components/carousel/embla/thumnail/thumnail-slider")
        )
      },
      {
        componentName: "progressCarousel",
        componentSrc: React.lazy(
          () => import("@/registry/components/carousel/progress-carousel")
        )
      }
    ],
    filesArray: [
      {
        fileName: "carousel1",
        fileSrc: "./src/registry/components/carousel/carousel1.tsx"
      },
      {
        fileName: "carousel2",
        fileSrc: "./src/registry/components/carousel/carousel2.tsx"
      },
      {
        fileName: "carousel3",
      ...
      {
        fileName: "carousel7",
        fileSrc: "./src/registry/components/carousel/embla/scale/scale-slider.tsx"
      },
      {
        fileName: "carousel8",
        fileSrc: "./src/registry/components/carousel/embla/autostart/autostart-slider.tsx"
      },
      {
        fileName: "carousel9",
        fileSrc: "./src/registry/components/carousel/embla/animation/animation-slider.tsx"
      },
      {
        fileName: "carousel10",
        fileSrc: "./src/registry/components/carousel/embla/thumnail/thumnail-slider.tsx"
      },
      {
        fileName: "progressCarousel",
        fileSrc: "./src/registry/components/carousel/progress-carousel.tsx"
      }
    ],
    slug: "carousel",
    type: "carousel"
    ...
    componentArray: [
      {
        ...
        componentSrc: React.lazy(
          () => import("@/registry/components/mousetrail/image-mousetrail")
        )
      },
      {
    ...
    filesArray: [
      {
        ...
        fileSrc: "./src/registry/components/mousetrail/image-mousetrail.tsx"
      },
      {
...
//# sourceMappingURL=compiled-contentlayer-config-K332AR23.mjs.map
