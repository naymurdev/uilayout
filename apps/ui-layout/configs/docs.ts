...
export const SpecialComponents = [
  ...
  { href: '/components/noise', name: 'Noise' },
  {
...
export const MainComponents = [
  ...
  { href: '/components/hover-cards', name: 'Hover cards', component: 'card' },
  {
  ...
  { href: '/components/dialog', name: 'Dialog', component: 'modal/drawer' },
  {
  ...
  { href: '/components/tabs', name: 'Tabs', component: 'tabs' },
  {
  ...
  { href: '/components/accordion', name: 'Accordion', component: 'accordion' },

  { href: '/components/faqs', name: 'FAQs', component: 'accordion' },
  {
    href: '/components/image-accordions',
    name: 'Image Accordion',
    component: 'accordion',
  },
  { href: '/components/grid', name: 'Grid', component: 'grid' },
  { href: '/components/masonary-grid', name: 'Masonary', component: 'grid' },

  { href: '/components/marquee', name: 'Marquee', component: 'marquee' },
  {
