  ...
  return (
    <>
      <div className='flex xl:flex-col xl:flex-nowrap flex-wrap  mx-auto lg:gap-5 gap-2 items-center justify-center lg:py-10 py-2 2xl:px-0 px-2'>
        ...
        <button className='group relative inline-flex h-12 2xl:w-36 xl:w-full w-36 text-sm items-center justify-center overflow-hidden rounded-md   bg-gradient-to-r dark:from-[#070e41] dark:to-[#263381] from-[#f6f7ff] to-[#f5f6ff] dark:border-[rgb(76_100_255)] border-2 border-[#263381] bg-transparent px-6 font-medium dark:text-white text-black transition-all duration-100 dark:[box-shadow:5px_5px_rgb(76_100_255)] [box-shadow:5px_5px_rgb(38_51_129)] active:translate-x-[3px] active:translate-y-[3px] active:[box-shadow:0px_0px_rgb(38_51_129)] dark:active:[box-shadow:0px_0px_rgb(76_100_255)]'>
          Contact me
        </button>
        ...
        <button className='relative inline-flex h-12 2xl:w-36 xl:w-full w-36 overflow-hidden rounded-full p-[2px] focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-offset-2 focus:ring-offset-gray-50'>
