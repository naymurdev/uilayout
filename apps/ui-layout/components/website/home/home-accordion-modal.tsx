      ...
      {items.map((item, i) => {
        return (
          <motion.article
            ...
            className={`h-[200px] w-[200px] flex-shrink-0 cursor-pointer border overflow-hidden dark:bg-black bg-gray-300 hover:bg-gray-200 dark:hover:bg-gray-950 rounded-md relative ${
              index === i ? 'z-[50] ' : ''
            }`}
          >
            <motion.img
